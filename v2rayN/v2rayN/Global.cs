...
namespace v2rayN
{
    class Global
    {
        ...
        public static readonly List<string> ssSecuritys = new List<string> { "aes-256-gcm", "aes-128-gcm", "aes-128-cfb", "chacha20-poly1305", "chacha20-ietf-poly1305", "none", "plain" };
